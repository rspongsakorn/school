...
- เนื้อหา: โลโก้ (`public/school-logo.png`), ชื่อโรงเรียน "โรงเรียนบัวใหญ่วิทยา", ที่อยู่ "อ.บัวใหญ่ จ.นครราชสีมา", ชื่อรายงาน, ปี/เทอม, ช่วงวันที่/ตัวกรองที่ใช้ (ถ้ามี), วันที่พิมพ์
